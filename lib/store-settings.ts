...
export const DEFAULT_STORE_SETTINGS: StoreSettings = {
  ...
  description: "Boutique premium de nutrition sportive et supplements de performance.",
...
export async function fetchStoreSettings(): Promise<StoreSettings> {
  try {
    ...
    const settings = {
      ...
      ...data,
      storeName: String(data.store_name || data.storeName || DEFAULT_STORE_SETTINGS.storeName),
      description: String(data.description || DEFAULT_STORE_SETTINGS.description),
      contactEmail: String(data.contact_email || data.contactEmail || DEFAULT_STORE_SETTINGS.contactEmail),
      phonePrimary: String(data.phone_primary || data.phonePrimary || DEFAULT_STORE_SETTINGS.phonePrimary),
      phoneSecondary: String(data.phone_secondary || data.phoneSecondary || DEFAULT_STORE_SETTINGS.phoneSecondary),
