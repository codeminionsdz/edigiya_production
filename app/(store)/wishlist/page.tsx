      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-center px-4 py-20">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          {locale === "fr"
            ...
            : "اضف منتجات الى المفضلة لتجدها هنا."}
        </p>
    ...
    <div className="mx-auto max-w-7xl px-4 py-8">
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          ...
          {locale === "fr" ? "produits sauvegardes" : "منتجات محفوظة"}
        </p>
      </div>
            ...
            return (
              ...
              >
                ...
                <Link
                  ...
                  className="relative aspect-square overflow-hidden bg-muted p-6"
                >
                ...
                <div className="flex flex-1 flex-col p-4">
                  ...
                  <Link href={`/product/${product.slug}`}>
                    <h3 className="mt-0.5 text-sm font-semibold text-foreground line-clamp-2 hover:text-primary">
                      {product.name[locale]}
                    </h3>
                  </Link>
