...
import { Plus, Edit, Trash2, GripVertical, Save, Copy, Eye, EyeOff } from "lucide-react"
...
export default function AdminNavbarPage() {
  ...
  const handleTogglePageNavbarVisibility = async (id: string, isVisible: boolean) => {
    try {
      const result = await updateCustomPage(id, { is_navbar_visible: !isVisible })
      if (result.error) {
        toast.error(result.error)
        return
      }
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Dialog open={isNavbarDialogOpen} onOpenChange={setIsNavbarDialogOpen}>
              ...
              <DialogContent className="max-w-2xl">
                <DialogHeader>
                  <DialogTitle>
                    {editingNavbarId ? "Edit Navbar Item" : "Create Navbar Item"}
                  </DialogTitle>
                </DialogHeader>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setNavbarForm({ ...navbarForm, label_ar: e.target.value })
                        }
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setNavbarForm({ ...navbarForm, label_fr: e.target.value })
                        }
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setNavbarForm({ ...navbarForm, target: e.target.value })
                        }
                        className="w-full rounded-md border border-input bg-background px-3 py-2"
                      >
        ...
        <CardContent>
          <div className="space-y-2">
            {navbarItems.length === 0 ? (
              <p className="text-sm text-muted-foreground">No navbar items yet</p>
            ) : (
              navbarItems.map((item) => (
                <div
                  key={item.id}
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="font-semibold">{item.label_en || item.label_fr}</div>
                  ...
                  <Button
                    size="sm"
                    variant="outline"
                    onClick={() => handleToggleNavbarItem(item.id, item.is_active)}
                  >
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Create and manage custom pages for your store</CardDescription>
            </div>
                      ...
                      <div className="flex items-center gap-2">
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            setPageForm({ ...pageForm, is_navbar_visible: checked })
                          }
                        />
                        <Label htmlFor="is_navbar_visible" className="cursor-pointer">
                          Show in Navbar
                        </Label>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e) =>
                          setPageForm({ ...pageForm, content_ar: e.target.value })
                        }
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e) =>
                          setPageForm({ ...pageForm, content_fr: e.target.value })
                        }
              ...
              customPages.map((page) => (
                ...
                >
                  ...
                  <Button
                    ...
                    variant="outline"
                    onClick={() =>
                      handleTogglePageNavbarVisibility(page.id, page.is_navbar_visible)
                    }
                    title={page.is_navbar_visible ? "Hide from navbar" : "Show in navbar"}
                  >
                    {page.is_navbar_visible ? (
                  ...
                  <Button
                    size="sm"
                    variant="outline"
                    onClick={() => handleTogglePageActive(page.id, page.is_active)}
                  >
