...
export default function AdminSettingsPage() {
    ...
    async function loadSettings() {
      try {
        ...
        try {
          ...
          console.error("Failed to load admin settings from localStorage:", fallbackError)
        }
      }
    }
  ...
  const handleSave = async () => {
    try {
      const savedSettings = await saveStoreSettingsToServer(settings)
