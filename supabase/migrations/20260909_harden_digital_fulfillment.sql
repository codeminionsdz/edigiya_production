-- Narrow remediation for digital fulfillment eligibility and event lookup performance.
CREATE INDEX IF NOT EXISTS fulfillment_events_fulfillment_id_idx
  ON fulfillment_events(fulfillment_id);
