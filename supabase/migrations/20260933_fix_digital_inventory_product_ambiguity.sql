-- Forward fix for the deployed default-key Vault admin RPC.
-- The product/variant lookup must qualify product_id because the function's
-- RETURNS TABLE also declares an output variable named product_id.
